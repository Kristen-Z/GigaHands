...
class HandVQVAE(nn.Module):
    def __init__(self,
        ...
        self.nb_joints = 42
        input_dim = 198 if 'MANO' in args.dataname else 126
        self.vqvae = VQVAE(input_dim, args, nb_code, code_dim, output_emb_width, down_t, stride_t, width, depth, dilation_growth_rate, activation=activation, norm=norm)
