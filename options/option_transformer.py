...
def get_args_parser():
    parser = argparse.ArgumentParser(description='Optimal Transport AutoEncoder training for Gigahands',
                                     add_help=True,
    ...
    parser.add_argument('--input-text', type=str, default='./input.txt', help='input text file')
    ...
    parser.add_argument('--exp-name', type=str, default='GPT', help='name of the experiment, will create a file inside out-dir')
